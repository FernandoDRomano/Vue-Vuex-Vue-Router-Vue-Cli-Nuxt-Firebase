<template>
    <div class="row justify-content-center">
        <div class="col-8">
            <h4 class="text-center font-weight-bold py-3">Agregar Tarea</h4>
            <form @submit.prevent="enviarFormulario" class="formulario">
                ...
                <div class="form-group">
                    ...
                    <textarea 
                        ...
                        name="descripcion" 
                        id="descripcion" cols="30" rows="5" class="form-control" 
                ...
                <div class="form-group">
                    <input :disabled="noEnviarMasDeUnaVez" type="submit" value="Guardar Tarea" class="btn btn-primary btn-block">
                </div>
            </form>
